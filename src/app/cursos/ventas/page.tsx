...
import { courseData } from '@/lib/ventas-course-data';
import type { Topic, Question } from '@/lib/course-data';
import { Progress } from "@/components/ui/progress";
import { CheckCircle, Circle, PlayCircle, Eye, Users, Handshake, Target, BrainCircuit, Calendar, ChevronRight, X, AlertTriangle, Frown } from "lucide-react";
import {
  Accordion,
  AccordionContent,
  AccordionItem,
