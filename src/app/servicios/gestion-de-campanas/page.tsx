        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative aspect-square">
               <Image
                src="https://images.unsplash.com/photo-1557804506-669a67965ba0?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NDE5ODJ8MHwxfHNlYXJjaHw0fHxhZCUyMGNhbXBhaWdufGVufDB8fHx8MTc2MjA5MzYyM3ww&ixlib=rb-4.1.0&q=80&w=1080"
                alt="Gestión de Campañas"
                fill
                className="rounded-lg object-cover shadow-xl"
                data-ai-hint="ad campaign"
              />
            </div>
          </div>
        </div>
